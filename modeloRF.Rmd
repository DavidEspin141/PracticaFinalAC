...
De esta manera, podemos apreciar que obtenemos un rendimiento bastante decente al ejecutar ambas pruebas, ya que obtenemos una fiabilidad del 88% en la primera versión (observando que los valores óptimos para "mtry" son de 2,8 y 15 en ese orden) y del 86% en laa segunda prueba, proporción bastante buena. Podemos apreciar lo previamente dicho, pese a no tener un tratamiento previo de los datos atípicos, obtenemos un buen rendimiento.
